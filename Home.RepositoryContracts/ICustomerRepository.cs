...
namespace Home.RepositoryContracts
{
    ...
    {
        Task<Customer?> GetByIdAsync(Guid customerId, bool includeOrders, CancellationToken ct = default);
        Task<IReadOnlyList<Customer>> GetAllAsync(CancellationToken ct = default);
        Task<IReadOnlyList<CustomerOrder>> GetOrdersByCustomerAsync(Guid customerId, bool includeItems = false, CancellationToken ct = default);

        void Add(Customer customer);
        void Update(Customer customer);
        void Remove(Customer customer);
        Task Remove(Guid customerId, CancellationToken ct = default);
